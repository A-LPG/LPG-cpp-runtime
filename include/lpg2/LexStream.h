    ...
    public ILexStream,public ParseErrorCodes
{
    ...
    int getStreamLength() override { return streamLength_; }
    ...
    void makeToken(int startLoc, int endLoc, int kind) override;

    void reportLexicalError(int left_loc, int right_loc)override;
    ...
    void reportLexicalError(int errorCode, int left_loc, int right_loc, int error_left_loc, int error_right_loc,
                            const std::vector<std::wstring>& errorInfo) override;
    ...
    // in the input stream.
    //
    void reportError(int errorCode, int leftToken, int rightToken, const std::wstring& errorInfo)override;

    void reportError(int errorCode, int leftToken, int rightToken, const std::vector<std::wstring>& errorInfo)override;
    ...
    std::wstring toString(int startOffset, int endOffset) override;
